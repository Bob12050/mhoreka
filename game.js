...
const MONSTER_TYPES = [
  { emoji: "🐗", name: "ドスイノシシ", hp: 40,  atk: 8,  mats: 2, interval: 2200, tele: 800, material: "イノシシの牙",   weak: "火" },
  { emoji: "🦇", name: "ギエナ",       hp: 35,  atk: 10, mats: 2, interval: 1300, tele: 520, material: "ギエナの翼膜",   weak: "火" },
  { emoji: "🦂", name: "ガミザミ",     hp: 55,  atk: 12, mats: 3, interval: 1500, tele: 560, material: "ガミザミの甲殻", weak: "雷" },
  { emoji: "🦅", name: "クルルヤック", hp: 70,  atk: 14, mats: 3, interval: 1600, tele: 600, material: "クルルの鱗",     weak: "水" },
  { emoji: "🦖", name: "リオレウス",   hp: 90,  atk: 16, mats: 4, interval: 1800, tele: 650, material: "火竜の鱗",       weak: "水", resist: "火" },
  { emoji: "🐊", name: "ジュラトドス", hp: 110, atk: 18, mats: 5, interval: 1900, tele: 680, material: "泥魚竜の鱗",     weak: "雷", resist: "水" },
  { emoji: "🐉", name: "古龍",         hp: 140, atk: 22, mats: 6, interval: 2000, tele: 700, material: "古龍の角",       weak: "龍", resist: "火" },
  { emoji: "🐲", name: "覇龍",         hp: 200, atk: 28, mats: 8, interval: 1800, tele: 640, material: "覇龍の宝玉",     weak: "雷", resist: "龍" },
];
...
const WEAPONS = [
  ...
  { id: "w_iron_gs",   name: "鉄の大剣",   type: "大剣",   atk: 22, ele: 0,  element: "無", cost: { "イノシシの牙": 4, "ガミザミの甲殻": 2 } },
  { id: "w_bone_hammer",name:"ボーンハンマー",type:"ハンマー",atk: 27, ele: 0, element: "無", cost: { "ギエナの翼膜": 4, "ガミザミの甲殻": 3 } },
  { id: "w_kulu_bow",  name: "クルルの弓",  type: "弓",     atk: 28, ele: 12, element: "水", cost: { "クルルの鱗": 5, "ギエナの翼膜": 3 } },
  { id: "w_thunder_db",name: "雷光の双剣",  type: "双剣",   atk: 32, ele: 15, element: "雷", cost: { "ガミザミの甲殻": 4, "クルルの鱗": 3 } },
  { id: "w_rathalos_ls",name:"火竜の太刀",  type: "太刀",   atk: 36, ele: 14, element: "火", cost: { "火竜の鱗": 5, "クルルの鱗": 3 } },
  { id: "w_jura_lance",name: "泥魚の槍",    type: "ランス", atk: 40, ele: 16, element: "水", cost: { "泥魚竜の鱗": 5, "火竜の鱗": 3 } },
  { id: "w_elder_gs",  name: "古龍剣",      type: "大剣",   atk: 50, ele: 18, element: "龍", cost: { "古龍の角": 4, "火竜の鱗": 4 } },
  { id: "w_kushala_hammer",name:"覇龍棍",   type: "ハンマー",atk: 62, ele: 22, element: "龍", cost: { "覇龍の宝玉": 2, "古龍の角": 3 } },
];
const SLOTS = ["頭", "胴", "腕", "腰", "脚"];
const ARMORS = [
  // レザー装備（序盤）
  { id: "a_leather_head", name: "レザーヘルム",  slot: "頭", def: 2, cost: { "イノシシの牙": 2 } },
  { id: "a_leather_body", name: "レザーメイル",  slot: "胴", def: 3, cost: { "イノシシの牙": 3 } },
  { id: "a_leather_arm",  name: "レザーアーム",  slot: "腕", def: 2, cost: { "ギエナの翼膜": 2 } },
  { id: "a_leather_waist",name: "レザーコイル",  slot: "腰", def: 2, cost: { "ギエナの翼膜": 2 } },
  { id: "a_leather_leg",  name: "レザーグリーヴ", slot: "脚", def: 2, cost: { "ガミザミの甲殻": 2 } },
  // 火竜装備（中盤）
  { id: "a_rath_head", name: "リオソウル【兜】", slot: "頭", def: 5, cost: { "火竜の鱗": 3, "クルルの鱗": 1 } },
  { id: "a_rath_body", name: "リオソウル【鎧】", slot: "胴", def: 6, cost: { "火竜の鱗": 4, "クルルの鱗": 2 } },
  { id: "a_rath_arm",  name: "リオソウル【腕】", slot: "腕", def: 5, cost: { "火竜の鱗": 3 } },
  { id: "a_rath_waist",name: "リオソウル【帯】", slot: "腰", def: 5, cost: { "火竜の鱗": 3 } },
  { id: "a_rath_leg",  name: "リオソウル【脚】", slot: "脚", def: 5, cost: { "火竜の鱗": 3, "泥魚竜の鱗": 1 } },
  // 古龍装備（終盤）
  { id: "a_elder_head", name: "古龍ノ兜", slot: "頭", def: 9,  cost: { "古龍の角": 2, "覇龍の宝玉": 1 } },
  { id: "a_elder_body", name: "古龍ノ鎧", slot: "胴", def: 10, cost: { "古龍の角": 3, "覇龍の宝玉": 1 } },
  { id: "a_elder_arm",  name: "古龍ノ腕", slot: "腕", def: 9,  cost: { "古龍の角": 2 } },
  { id: "a_elder_waist",name: "古龍ノ帯", slot: "腰", def: 9,  cost: { "古龍の角": 2 } },
  { id: "a_elder_leg",  name: "古龍ノ脚", slot: "脚", def: 9,  cost: { "古龍の角": 2, "泥魚竜の鱗": 2 } },
];
...
function load() {
  try {
    ...
    if (s.armor) for (const slot of SLOTS) player.armor[slot] = s.armor[slot] ?? null;
