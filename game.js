...
// material=ドロップ素材名 / mats=ドロップ個数
const MONSTER_TYPES = [
  { emoji: "🐗", name: "ドスイノシシ", hp: 40,  atk: 8,  mats: 2, interval: 2200, tele: 800, material: "イノシシの牙" },
  { emoji: "🦇", name: "ギエナ",       hp: 35,  atk: 10, mats: 2, interval: 1300, tele: 520, material: "ギエナの翼膜" },
  { emoji: "🦂", name: "ガミザミ",     hp: 55,  atk: 12, mats: 3, interval: 1500, tele: 560, material: "ガミザミの甲殻" },
  { emoji: "🦅", name: "クルルヤック", hp: 70,  atk: 14, mats: 3, interval: 1600, tele: 600, material: "クルルの鱗" },
  { emoji: "🦖", name: "リオレウス",   hp: 90,  atk: 16, mats: 4, interval: 1800, tele: 650, material: "火竜の鱗" },
  { emoji: "🐊", name: "ジュラトドス", hp: 110, atk: 18, mats: 5, interval: 1900, tele: 680, material: "泥魚竜の鱗" },
  { emoji: "🐉", name: "古龍",         hp: 140, atk: 22, mats: 6, interval: 2000, tele: 700, material: "古龍の角" },
  { emoji: "🐲", name: "覇龍",         hp: 200, atk: 28, mats: 8, interval: 1800, tele: 640, material: "覇龍の宝玉" },
];
...
// ============================================================
const WEAPONS = [
  { id: "w_iron_sns",  name: "鉄の片手剣", type: "片手剣", atk: 14, cost: {} }, // 初期装備
  { id: "w_iron_gs",   name: "鉄の大剣",   type: "大剣",   atk: 22, cost: { "イノシシの牙": 4, "ガミザミの甲殻": 2 } },
  { id: "w_bone_hammer",name:"ボーンハンマー",type:"ハンマー",atk: 27, cost: { "ギエナの翼膜": 4, "ガミザミの甲殻": 3 } },
  { id: "w_kulu_bow",  name: "クルルの弓",  type: "弓",     atk: 31, cost: { "クルルの鱗": 5, "ギエナの翼膜": 3 } },
  { id: "w_rathalos_ls",name:"火竜の太刀",  type: "太刀",   atk: 38, cost: { "火竜の鱗": 5, "クルルの鱗": 3 } },
  { id: "w_jura_lance",name: "泥魚の槍",    type: "ランス", atk: 42, cost: { "泥魚竜の鱗": 5, "火竜の鱗": 3 } },
  { id: "w_elder_gs",  name: "古龍剣",      type: "大剣",   atk: 52, cost: { "古龍の角": 4, "火竜の鱗": 4 } },
  { id: "w_kushala_hammer",name:"覇龍棍",   type: "ハンマー",atk: 66, cost: { "覇龍の宝玉": 2, "古龍の角": 3 } },
];
...
function gearCard(item, kind) {
  ...
  const stat = kind === "weapon" ? `攻撃 ${item.atk}` : `防御 ${item.def}`;
